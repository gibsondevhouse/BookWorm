...
- [x] [Phase 0 Overview](./phase-0/phase-0.md)
...
- [x] [Part 01: Express Runtime Shell](./phase-0/stage-02-core-runtime-and-auth/part-01-express-runtime-shell/part-01-express-runtime-shell.md)
- [x] [Part 02: Session Authentication Skeleton](./phase-0/stage-02-core-runtime-and-auth/part-02-session-authentication-skeleton/part-02-session-authentication-skeleton.md)
- [x] [Part 03: Config and Ops Baseline](./phase-0/stage-02-core-runtime-and-auth/part-03-config-and-ops-baseline/part-03-config-and-ops-baseline.md)

#### Phase 0 Stage 03

- [x] [Stage 03 Overview](./phase-0/stage-03-data-model-and-release-spine/stage-03-data-model-and-release-spine.md)
- [x] [Part 01: Prisma Initial Schema](./phase-0/stage-03-data-model-and-release-spine/part-01-prisma-initial-schema/part-01-prisma-initial-schema.md)
- [x] [Part 02: Revision and Release Composition](./phase-0/stage-03-data-model-and-release-spine/part-02-revision-and-release-composition/part-02-revision-and-release-composition.md)
- [x] [Part 03: Seed and Fixture Baseline](./phase-0/stage-03-data-model-and-release-spine/part-03-seed-and-fixture-baseline/part-03-seed-and-fixture-baseline.md)

#### Phase 0 Stage 04

- [x] [Stage 04 Overview](./phase-0/stage-04-first-vertical-slice/stage-04-first-vertical-slice.md)
- [x] [Part 01: Admin Character Draft Flow](./phase-0/stage-04-first-vertical-slice/part-01-admin-character-draft-flow/part-01-admin-character-draft-flow.md)
- [x] [Part 02: Active Release Public Read](./phase-0/stage-04-first-vertical-slice/part-02-active-release-public-read/part-02-active-release-public-read.md)
- [x] [Part 03: Phase 0 Verification Gate](./phase-0/stage-04-first-vertical-slice/part-03-phase-0-verification-gate/part-03-phase-0-verification-gate.md)

### Phase 1

- [x] [Phase 1 Overview](./phase-1/phase-1.md)

#### Phase 1 Stage 01

- [x] [Stage 01 Overview](./phase-1/stage-01-expanded-content-spine/stage-01-expanded-content-spine.md)
- [x] [Part 01: Additional Entity Modeling](./phase-1/stage-01-expanded-content-spine/part-01-additional-entity-modeling/part-01-additional-entity-modeling.md)
- [x] [Part 02: Relationship Revision Foundation](./phase-1/stage-01-expanded-content-spine/part-02-relationship-revision-foundation/part-02-relationship-revision-foundation.md)
- [x] [Part 03: Dependency Resolution Baseline](./phase-1/stage-01-expanded-content-spine/part-03-dependency-resolution-baseline/part-03-dependency-resolution-baseline.md)

#### Phase 1 Stage 02

- [x] [Stage 02 Overview](./phase-1/stage-02-authoring-surface-expansion/stage-02-authoring-surface-expansion.md)
- [x] [Part 01: Admin Content Retrieval Baseline](./phase-1/stage-02-authoring-surface-expansion/part-01-admin-content-retrieval-baseline/part-01-admin-content-retrieval-baseline.md)
- [x] [Part 02: Draft Editing for Expanded Types](./phase-1/stage-02-authoring-surface-expansion/part-02-draft-editing-for-expanded-types/part-02-draft-editing-for-expanded-types.md)
- [x] [Part 03: Relationship Authoring Flow](./phase-1/stage-02-authoring-surface-expansion/part-03-relationship-authoring-flow/part-03-relationship-authoring-flow.md)

#### Phase 1 Stage 03

- [x] [Stage 03 Overview](./phase-1/stage-03-release-validation-and-review/stage-03-release-validation-and-review.md)
- [x] [Part 01: Release Validation Baseline](./phase-1/stage-03-release-validation-and-review/part-01-release-validation-baseline/part-01-release-validation-baseline.md)
- [x] [Part 02: Release Review Surface](./phase-1/stage-03-release-validation-and-review/part-02-release-review-surface/part-02-release-review-surface.md)
- [x] [Part 03: Activation Guardrails](./phase-1/stage-03-release-validation-and-review/part-03-activation-guardrails/part-03-activation-guardrails.md)

#### Phase 1 Stage 04

- [x] [Stage 04 Overview](./phase-1/stage-04-public-coverage-and-verification/stage-04-public-coverage-and-verification.md)
- [x] [Part 01: Expanded Public Read Paths](./phase-1/stage-04-public-coverage-and-verification/part-01-expanded-public-read-paths/part-01-expanded-public-read-paths.md)
- [x] [Part 02: Public Discovery Baseline](./phase-1/stage-04-public-coverage-and-verification/part-02-public-discovery-baseline/part-02-public-discovery-baseline.md)
- [x] [Part 03: Phase 1 Verification Gate](./phase-1/stage-04-public-coverage-and-verification/part-03-phase-1-verification-gate/part-03-phase-1-verification-gate.md)
...
- [x] [Stage 01 Overview](./phase-2/stage-01-comprehensive-entity-management/stage-01-comprehensive-entity-management.md)
- [x] [Part 01: Remaining Entity Type Schema](./phase-2/stage-01-comprehensive-entity-management/part-01-remaining-entity-type-schema/part-01-remaining-entity-type-schema.md)
- [x] [Part 02: Full Admin CRUD Coverage](./phase-2/stage-01-comprehensive-entity-management/part-02-full-admin-crud-coverage/part-02-full-admin-crud-coverage.md)
- [x] [Part 02b: Admin Update and Retire Completion](./phase-2/stage-01-comprehensive-entity-management/part-02b-admin-update-and-retire-completion/part-02b-admin-update-and-retire-completion.md)
- [x] [Part 03: Metadata, Visibility, and Timeline Baseline](./phase-2/stage-01-comprehensive-entity-management/part-03-metadata-visibility-and-timeline-baseline/part-03-metadata-visibility-and-timeline-baseline.md)

#### Phase 2 Stage 02

- [x] [Stage 02 Overview](./phase-2/stage-02-public-codex-and-reader/stage-02-public-codex-and-reader.md)
- [x] [Part 01: Public Codex Detail Baseline](./phase-2/stage-02-public-codex-and-reader/part-01-public-codex-detail-baseline/part-01-public-codex-detail-baseline.md)
- [x] Slice complete under Part 01: Release-Selectable Codex Related-Content Neighbors API Baseline
- [x] [Part 02: Timeline Surface Baseline](./phase-2/stage-02-public-codex-and-reader/part-02-timeline-surface-baseline/part-02-timeline-surface-baseline.md)
- [x] [Part 03: Chapter Reader and Edition Selection](./phase-2/stage-02-public-codex-and-reader/part-03-chapter-reader-and-edition-selection/part-03-chapter-reader-and-edition-selection.md)

#### Phase 2 Stage 03

- [x] [Stage 03 Overview](./phase-2/stage-03-search-and-continuity-foundation/stage-03-search-and-continuity-foundation.md)
- [x] [Part 01: Search Index Contract](./phase-2/stage-03-search-and-continuity-foundation/part-01-search-index-contract/part-01-search-index-contract.md)
- [x] [Part 02: Search API and Public Surface](./phase-2/stage-03-search-and-continuity-foundation/part-02-search-api-and-public-surface/part-02-search-api-and-public-surface.md)
- [x] [Part 03: Continuity Issue Baseline](./phase-2/stage-03-search-and-continuity-foundation/part-03-continuity-issue-baseline/part-03-continuity-issue-baseline.md)
...
- Do not mark a stage complete until all of its parts are complete.
- Do not mark Phase 0 complete until all stage overviews and all parts are complete.
- Use the linked stage and part documents as the execution source, not this tracker.
